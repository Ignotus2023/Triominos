...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get gameAbandon => 'Abandonner la partie';

  @override
  String get gameAbandonConfirm =>
      'Abandonner cette partie sans enregistrer le résultat ?';
  ...
  String inputPassPenalty(int penalty) {
    return 'Aucun coup – passer ($penalty)';
  }

  @override
  String inputDrawsUsed(int used, int max) {
    return 'Pioches : $used/$max';
  }
  ...
  @override
  String get statsTotalHexagons => 'Hexagones au total';
